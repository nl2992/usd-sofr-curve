...
print()
print("Test 2 calls VBA. It needs, in THIS workbook:")
print("  Alt+F11 > File > Import File > bloomberg/vba/CurveVBA.bas")
print("  then Save As .xlsm (a .xlsx cannot hold the module)")
print("Testing!H56 reports whether the module is answering.")

...
'------------------------------------------------------------------------------
' NOTE: TenorDate / AddBusDays used to live here as well. They were removed
' because CurveVBA.bas defines the same names - importing both modules gives
' "Ambiguous name detected" at compile time, and that disables every UDF in the
' project, not just these two. Use CurveVBA.TenorDate.
'------------------------------------------------------------------------------
